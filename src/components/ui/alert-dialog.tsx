...
function AlertDialogContent({
  ...
  return (
    <AlertDialogPortal>
      {/* Flex centering wrapper - avoids translate/transform conflicts with animations */}
      <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
        <AlertDialogPrimitive.Overlay className="absolute inset-0 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 bg-black/50 pointer-events-auto" />
